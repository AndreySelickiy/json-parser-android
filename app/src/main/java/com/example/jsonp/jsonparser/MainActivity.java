package com.example.jsonp.jsonparser;
...
import com.example.jsonp.jsonparser.model.Category;
import com.example.jsonp.jsonparser.model.Product;
...
import static com.example.jsonp.jsonparser.WalmartHttpClient.API_KEY;
import static com.example.jsonp.jsonparser.WalmartHttpClient.BASE_URL;
import static com.example.jsonp.jsonparser.WalmartHttpClient.CATID_URL;
import static com.example.jsonp.jsonparser.WalmartHttpClient.COUNT_URL;
import static com.example.jsonp.jsonparser.WalmartHttpClient.PROD_URL;
import static com.example.jsonp.jsonparser.WalmartHttpClient.QUERY_URL;
import static com.example.jsonp.jsonparser.WalmartHttpClient.SEARCH_URL;
import static com.example.jsonp.jsonparser.WalmartHttpClient.V_URL;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv = findViewById(RESULT_CANCELED.id.categoriesList);
        gv = findViewById(RESULT_CANCELED.id.productGrid);
        nextButton = findViewById(RESULT_CANCELED.id.nextButton);
        prevButton = findViewById(RESULT_CANCELED.id.prevButton);
        editText = findViewById(RESULT_CANCELED.id.searchInput);
